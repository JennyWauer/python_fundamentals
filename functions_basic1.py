...
#     print(b+c)
# print(a(1,2) + a(2,3))
# # prediction: prints none correct prediction: error
...
def a():
    ...
    return 7
print(a())
# prediction: prints 100 correct: prints 100 and 10
...
a()
print(b)
# prediction: prints 500, 500, 300, 300 correct prediction: 500, 500, 300, 500
